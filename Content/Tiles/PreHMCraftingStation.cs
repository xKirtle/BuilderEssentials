...
public class PreHMCraftingStation : BaseCraftingStation
{
    ...
    public override int[] AdjacentTiles() => new int[] {
        TileID.WorkBenches, TileID.Furnaces, TileID.Hellforge, TileID.Anvils, TileID.Bottles, TileID.Pots, TileID.AlchemyTable, TileID.Sinks,
    ...
    public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16,
        32, 16, ModContent.ItemType<PreHMCraftingItem>());
}